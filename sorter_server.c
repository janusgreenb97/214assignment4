...
int main(int argc, char **argv)
{
    ...
    char ipaddress[100],newaddress[100];
   ...
   // printf("Waiting for connections...\n");
    ...
    while (1) {
        ...
        inet_ntop(AF_INET,&client_address.sin_addr.s_addr,newaddress,sizeof(newaddress));
       // printf("[+] Connect to client %d",client_sock);
        if(strcmp(newaddress,ipaddress)!=0){
            strcpy(ipaddress,newaddress);
            printf("%s,", ipaddress);
            fflush(stdout);
        }
